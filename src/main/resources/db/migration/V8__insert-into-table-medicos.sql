DELETE FROM `vollmed-api`.`medicos`;


INSERT INTO `vollmed-api`.`medicos` (`id`, `nombre`, `email`, `documento`, `especialidad`, `calle`, `distrito`, `complemento`, `numero`, `ciudad`, `telefono`, `activo`)
